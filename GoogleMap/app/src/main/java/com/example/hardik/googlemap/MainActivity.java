...
GoogleMap mgoogleMap;
    ...
    String url="http://192.168.0.106:80/update.php";
    @Override
    ...
    public void onConnected(@Nullable Bundle bundle) {
        ...
        if(mLocation!=null)
        {
            ...
            Toast.makeText(getBaseContext(), "mLocationNull!!!!",Toast.LENGTH_LONG).show();
        }
    ...
    private void createMarker(double lat, double lng) {
        ...
        if(marker!=null){
          Toast.makeText(getBaseContext(),"marker present",Toast.LENGTH_SHORT).show();
        ...
        addToDatabase(lat,lng);
    }
    public void addToDatabase(double lat,double lng) {
    ...
    public void onLocationChanged(Location location) {
        ...
        goToLocation(mLocation.getLatitude(),mLocation.getLongitude(),15);
