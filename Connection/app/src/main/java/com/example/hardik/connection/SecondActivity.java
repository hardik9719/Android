...
public class SecondActivity extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks,
    ...
    private long UPDATE_INTERVAL = 2000;  /* 15 secs */
    ...
    protected void onStart() {
        ...
        if (mGoogleApiClient != null) {
            ...
            latLng.setText( "  mgoogleclientapi is NULL!");
        }
    }
